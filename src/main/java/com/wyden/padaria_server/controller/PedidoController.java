...
public class PedidoController {
    ...
    @PutMapping("/editar-status/{pedidoId}")
    public ResponseEntity<PedidoDTO> editarStatusPedido(@PathVariable Long pedidoId, @RequestBody String novoStatus) {
        PedidoDTO pedidoDTO = pedidoService.editarStatusPedido(pedidoId, novoStatus);
